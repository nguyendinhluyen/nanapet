...
<form method='POST' enctype='multipart/form-data' id = "frm" name = "frm">
    ...
    <div style = "float:left">
        ...
        <div class = "title" style = 'width:851px; margin-top: 5px; margin-bottom: 5px'>
            ...
            <div class = "con_title" style = "width:220px;">
            ...
            <div class = "con_title" style = "width:auto;text-decoration:underline">
                <a href = './?show=product&order=price_desc&p={p}'>Giảm </a>
            </div>
            <div class = "con_title" style = "width:auto;text-decoration:none">&nbsp-&nbsp </div>
            <div class = "con_title" style = "width:auto;text-decoration:underline"><a href = './?show=product&order=price_asc&p={p}'> Tăng</a></div>
            <div class = "con_title" style = "width:60px; text-align:center">Copy</div>
        ...
        <div>
            ...
            <div class = "con_list_con" style = "width:220px;background-color:{color};height:50px;">{product_name}</div>
            ...
            <div class = "con_list_con" style = "width:50px;background-color:{color};height:50px;">
                <a href="?show=product&action=copy&id={id}&p={p}&order={oderby}">Copy</a>
            </div>
            <div class ='clear'></div>
            <!--END_PRODUCT-->
            <!--ENDLIST_PRODUCT-->
