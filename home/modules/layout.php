<?php
    ...
    $href_banner = GetOnef('config_value', 'config', 'config_name="href_banner"');
    $href_banner_2 = GetOnef('config_value', 'config', 'config_name="href_banner_2"');
    $href_banner_3 = GetOnef('config_value', 'config', 'config_name="href_banner_3"');
    $href_banner_4 = GetOnef('config_value', 'config', 'config_name="href_banner_4"');
    $href_banner_5 = GetOnef('config_value', 'config', 'config_name="href_banner_5"');
    $introduce_nanapet = GetOnef('config_value', 'config', 'config_name="introduce"');
