        ...
        if (authResult['status']['signed_in']) {
            ...
            gapi.client.load('plus', 'v1', function () {
                ...
                request.execute(function (resp) {
                    ...
                    alert(result);
                    if (result === "Đăng nhập thành công.") window.location = 'thong-tin-tai-khoan';
                    else window.location = 'dang-nhap';
                });
            });
        } else {
...
<script>
    ...
    function getUserInfo() {
        ...
        FB.api('/me', function (response) {
            ...
            alert(userId);
            if (userId === "Đăng nhập thành công.") window.location = 'thong-tin-tai-khoan';
            else window.location = 'dang-nhap';
        });
    }
</script>
